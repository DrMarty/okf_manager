...
def main(argv: list[str]) -> int:
    ...
    # Self-check: the generated file must be standalone and contain embedded graph data.
    if '<script id="bundle-data" type="application/json">' not in page or '<canvas id="graph">' not in page:
        print("Generated visualization missing required live self-graph elements", file=sys.stderr)
        return 1
    print(json.dumps({
